...
class CsvExporter
{
    public static function build(array $payload): string
    {
        ...
        $lines = [];
        $lines[] = 'Jahr;Restschuld Ende;Immobilienvermögen;Depot gesamt;Vorsprung;Zinslast;Tilgung;Hausgeld;Instandhaltung;Sparrate;Zinsertrag Anlage;Miete;Ø Eigentümer/Monat;Ø Miete/Monat';
        ...
        $lines[] = '';
        $lines[] = 'Monat;Restschuld;Zins;Tilgung;Sonder;Hausgeld;Instandhaltung;Gesamt Eigentümer;Miete;Sparrate;Depot gesamt;Zinsertrag Anlage';
