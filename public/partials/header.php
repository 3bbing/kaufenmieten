...
<head>
    ...
    <style>
        ...
        .dark .form-field input[type="number"],
        .dark .form-field input[type="text"],
        .dark .form-field input[type="checkbox"],
        .dark .form-field input[type="range"],
        ...
        .btn-primary {
            ...
            color: white;
            box-shadow: 0 10px 20px -12px rgba(59,130,246,0.8);
        }
        .btn-secondary {
